...
Hello and welcome! I’m a Machine Learning Research Engineer with 9+ years translating AI research into production clinical systems — including three deployed ophthalmic AI applications on the Heidelberg Engineering AppWay ecosystem and a label-free retinal segmentation system live on UPMC MyApps and actively used by clinicians across the health network. My work spans computer vision, multimodal deep learning, and molecular generative modeling, backed by peer-reviewed publications, 25+ ARVO poster contributions, and session moderation at the Retina in AI track.
